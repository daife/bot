...
class ActionControl01(Node):
    ...
    def __init__(self, name):
        ...
        self.action_client_ = ActionClient(self, MoveArm, 'move_arm')
    ...
    def send_goal(self):
        ...
        goal_msg.pose = 20.0  # 设置目标角度，字段名与action定义一致
...
def main(args=None):
    ...
    action_arm_01 = ActionControl01("action_control_01")
    rclpy.spin(action_arm_01)
    rclpy.shutdown()